export default {
    ...
    canvas: {
        ...
        nodeTypes: { image: "Image", text: "Text", config: "Generation config", video: "Video", audio: "Audio", group: "Group", characterCard: "Character card", propCard: "Prop card", sceneCard: "Scene card" },
        toolbar: {
            select: "Select", pan: "Move", text: "Text", image: "Image", video: "Video", audio: "Audio", config: "Generation config", group: "Group", characterCard: "Character card", propCard: "Prop card", sceneCard: "Scene card", extensions: "Extension nodes", upload: "Upload assets", appearance: "Canvas appearance", arrangeHorizontally: "Space horizontally and align top", arrangeVertically: "Space vertically and align right", arrangeGrid: "Arrange in grid", clear: "Clear canvas",
        ...
        sidePanel: {
            ...
            filter: { image: "Image", video: "Video", text: "Text", audio: "Audio", config: "Configuration", group: "Group", "character-card": "Character card", "prop-card": "Prop card", "scene-card": "Scene card" },
        },
        ...
        references: { title: "References", select: "Select references from canvas", disconnect: "Disconnect reference", mention: "Add to prompt", empty: "No content", selecting: "Adding references", choose: "Select", selectingHint: "Select references from canvas · ESC to return" },
        card: { characterName: "Character name", name: "Card name", face: "Face", outfit: "Outfit", image: "Upload image", voice: "Upload voice", uploadVoice: "Upload voice", replace: "Replace image" },

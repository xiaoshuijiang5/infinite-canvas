export default {
    ...
    canvas: {
        ...
        card: { characterName: "Character name", name: "Card name", appearance: "Appearance", image: "Upload image", voice: "Upload voice", uploadVoice: "Upload voice", replace: "Replace image" },

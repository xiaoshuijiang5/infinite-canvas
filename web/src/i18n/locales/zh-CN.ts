export default {
    ...
    canvas: {
        ...
        nodeTypes: { image: "图片", text: "文本", config: "生成配置", video: "视频", audio: "音频", group: "组", characterCard: "角色卡", propCard: "道具卡", sceneCard: "场景卡" },
        toolbar: {
            select: "选择", pan: "移动", text: "文本", image: "图片", video: "视频", audio: "音频", config: "生成配置", group: "组", characterCard: "角色卡", propCard: "道具卡", sceneCard: "场景卡", extensions: "扩展节点", upload: "上传资产", appearance: "画布外观", arrangeHorizontally: "左右等距排布（上对齐）", arrangeVertically: "上下等距排布（右对齐）", arrangeGrid: "宫格等距排布", clear: "清空画布",
        ...
        sidePanel: {
            ...
            filter: { image: "图片", video: "视频", text: "文本", audio: "音频", config: "配置", group: "分组", "character-card": "角色卡", "prop-card": "道具卡", "scene-card": "场景卡" },
        },
        ...
        references: { title: "参考内容", select: "从画布选择参考节点", disconnect: "断开参考连接", mention: "引用到提示词", empty: "暂无内容", selecting: "正在添加参考", choose: "选择", selectingHint: "从画布选择参考 · ESC 返回输入框" },
        card: { characterName: "人物名称", name: "卡片名称", face: "人物特写", outfit: "人物服装", image: "上传图片", voice: "上传角色声音", uploadVoice: "上传声音", replace: "替换图片" },
